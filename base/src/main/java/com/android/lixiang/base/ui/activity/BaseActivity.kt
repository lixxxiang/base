...
open class BaseActivity: RxActivity(), ISupportActivity{
    ...
    fun getTopFragment(): ISupportFragment {
        return SupportHelper.getTopFragment(_mActivity.getSupportFragmentManager())
    }
    ...
    fun <T : ISupportFragment> findFragment(fragmentClass: Class<T>): T {
        return SupportHelper.findFragment(_mActivity.getSupportFragmentManager(), fragmentClass)
    }
}